...
<body>
	...
	<div class="container">
		...
		<div>
			<h3 class='pt-2 pb-1'>
				Oh no! Looks like your cart is empty. <i class='fa fa-frown-o'
					aria-hidden='true'></i>
			</h3>
		</div>
		<div class='pt-2 pb-1'>
			<button type='reset' name='button' id='buttonReturn'
				class="page-button" value='Return'>Return</button>
		</div>
		<%
			} else {
		...
		<div class='row'>
			<div class='col'>
				...
				<p class="pl-2">
					<strong><%=item.getQuantity()%> X</strong> &nbsp;
		...
		<div class="row">
			<div class="col ">
				<form action="deductionofStocks" method="GET">
					<div>
						<h2><i class="fa fa-address-card-o" aria-hidden="true"></i> Delivery Address</h2>
						<br>
						<div class="row ml-2 ">
						<div class="col-xs-4 ">
						 <input type="text" name="HomeAddress"
							placeholder="Please enter your address" class="form-control" required/>
							</div>
						</div>
					</div>
					<%
					...
					%>
					<br>
					<input class="float-right input-styling" type="submit"
						value="Check Out" />
				</form>
			</div>
		</div>
